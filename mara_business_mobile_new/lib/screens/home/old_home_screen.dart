...
import '../vendors/all_vendors_screen.dart';
import '../vendors/shops_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
          ...
          CustomScrollView(
            ...
            slivers: [
              ...
              SliverAppBar(
                ...
                toolbarHeight: 70,
                title: _buildHeader(context, cartProvider, wishlistProvider),
              ),
  ...
  // Header widget
  Widget _buildHeader(BuildContext context, CartProvider cartProvider, WishlistProvider wishlistProvider) {
    return Consumer<NavbarProvider>(
      builder: (context, navbarProvider, child) {
        final currentLang = navbarProvider.currentLanguageObj;
          ...
          children: [
            ...
            PopupMenuButton<String>(
              ...
              onSelected: (String langCode) async {
                await navbarProvider.switchLanguage(langCode);
              },
              itemBuilder: (context) => navbarProvider.languages.map((lang) {
                return PopupMenuItem(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(lang.name),
                      if (lang.code == navbarProvider.currentLanguage)
                        const Padding(
            ...
            Stack(
              ...
              children: [
                ...
                if (wishlistProvider.totalCount > 0)
                  Positioned(
                    right: 8,
                    top: 8,
                    child: Container(
