// lib/screens/product/product_detail_screen.dart - COMPLETE FIXED VERSION
...
import '../../core/models/product_detail_models.dart'; // ADD THIS IMPORT
...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ReviewListScreen(
          ...
          initialReviews: product.reviews, // Now passing List<Review>
        ),
      ),
    );
  }
    ...
    return Scaffold(
      ...
      body: Consumer<ProductProvider>(
        builder: (context, provider, child) {
          // FIXED: Use isLoadingDetail instead of isLoading
          ...
          // FIXED: Use detailError instead of error
          ...
          return CustomScrollView(
            slivers: [
                  ...
                  Consumer<WishlistProvider>(
                    builder: (context, wishlist, _) {
                      final isInWishlist = wishlist.items.any(
                        (item) => item['vendor_product_id'] == widget.vendorProductId,
                      );
                      return IconButton(
                        icon: Container(
                          padding: const EdgeInsets.all(8),
                        ...
                        onPressed: () async {
                          if (isInWishlist) {
                            await wishlist.removeFromWishlist(widget.vendorProductId);
                          } else {
                            await wishlist.addToWishlist(widget.vendorProductId);
                          }
                        },
                      );
                    },
              ...
              // Add this after the Specifications section and before the Reviews section
              // Look for the comment "// Reviews section" and add this before it
  ...
  Future<void> _submitReview() async {
    ...
    _showMessage('Avis soumis avec succès!', Colors.green);
    setState(() {
      _isEditingReview = false;
      _rating = 0;
      _commentController.clear();
