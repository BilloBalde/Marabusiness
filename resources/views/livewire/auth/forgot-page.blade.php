          ...
          <div class="mt-5">
            ...
            <form wire:submit.prevent="save" class="space-y-4">
              <div class="grid gap-y-4">
                @if (session('success'))
                    <div class="px-4 py-3 mb-4 text-sm bg-green-500 border border-green-200 rounded-lg text-white-700 dark:bg-green-800 dark:text-white-100 dark:border-green-700">
                        {{ session('success') }}
                    </div>
                @endif
                <!-- Form Group -->
