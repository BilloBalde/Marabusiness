    ...
    <main class="w-full max-w-md p-6 mx-auto">
      <div class="bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
        <div class="p-4 sm:p-7">
          ...
          @if (session('error'))
            <div class="px-4 py-3 mb-4 text-sm text-red-700 bg-red-100 border border-red-200 rounded-lg dark:bg-red-800 dark:text-red-100 dark:border-red-700">
                {{ session('error') }}
            </div>
        @endif
          <!-- Form -->
            ...
            <div class="grid gap-y-4">
              ...
              <div>
                <div class="flex items-center justify-between">
                  ...
                  <a class="text-sm font-medium text-blue-600 decoration-2 hover:underline dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/forgot-password">Mot de Passe Oublié?</a>
                </div>
                <div class="relative">
              ...
              <!-- Remember Me -->
                ...
                <input type="checkbox" id="remember" wire:model="remember" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600">
                <label for="remember" class="text-sm text-gray-600 ms-2 dark:text-gray-400">Se souvenir de moi</label>
                </div>
              <!-- End Form Group -->
