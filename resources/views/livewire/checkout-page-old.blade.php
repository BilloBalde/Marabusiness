		...
		<div class="col-span-12 md:col-span-12 lg:col-span-8">
			...
			<div class="p-4 bg-white shadow rounded-xl sm:p-7 dark:bg-slate-900">
				...
				<div class="mb-6">
                    ...
                    <div class="mt-4">
                        <label class="block mb-1 text-gray-700 dark:text-white" for="shipping_carrier">
                            Shipping Carrier
                        </label>
                        <select id="shipping_carrier"
                            wire:model="shipping_carrier"
                            class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-none @error('shipping_carrier') border-red-500 @enderror">
