<header class="sticky top-0 z-50 flex flex-wrap w-full py-3 text-sm bg-white shadow-md md:justify-start md:flex-nowrap md:py-0 dark:bg-white-800">
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/" aria-label="Brand"><img src="{{ asset('assets/images/logo.png') }}" alt="" style="width: 100px; height: 60px"></a>
                <div class="md:hidden">
                        ...
                        @auth
                            <div class="relative inline-flex hs-dropdown">
                                <button type="button"
                                        ...
                                        data-hs-dropdown-toggle="#hs-dropdown-basic-menu"
                                        class="flex items-center text-gray-500">
                                    {{ auth()->user()->name }}
                                    <svg class="w-4 h-4 ms-2" ...>...</svg>
                                </button>

                                <div id="hs-dropdown-basic-menu"
                                    class="z-10 hidden p-2 bg-white rounded-lg shadow-md hs-dropdown-menu">
                                    <a class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" href="/orders">My Orders</a>
                                    @php
                                        $user = auth()->user();
                                    ...
                                    @endphp
                                    @if ($role == 'customer')
                                        <a class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" href="/chats/{{ $managerId }}">My Chats</a>
                                    @endif
